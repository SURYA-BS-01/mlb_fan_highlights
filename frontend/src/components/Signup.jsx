...
//         alert(error.response.data.detail); // Display backend error message
//       } else {
            ...
            <button
              ...
              className={`w-full py-3 px-4 rounded-lg font-medium transition duration-300 ${
                loading || passwordError
                  ...
                  : "bg-gradient-to-r from-blue-500 to-purple-500 text-white hover:from-blue-600 hover:to-purple-600 focus:ring-4 focus:ring-blue-300/50 focus:outline-none"
              }`}
            >
              {loading ? (
                <div className="flex items-center justify-center">
